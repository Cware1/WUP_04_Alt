...
First I plotted a graphical descriptive. Unfortunately, we were unable to determine if there was a difference between the scores based on RACES due to the data being unclear.